namespace Nancy.Testing
{
  ...
  public class Browser : IHideObjectMembers
  {
    ...
    /// <param name="defaults">The default <see cref="BrowserContext"/> that should be used in a all requests through this browser object.</param>
    public Browser(INancyBootstrapper bootstrapper, Action<BrowserContext> defaults = null, bool initializeBootstrapper = true)
    {
      this.bootstrapper = bootstrapper;
      if (initializeBootstrapper) this.bootstrapper.Initialise();
